---
title: "Egzamin (pierwszy termin) - Wizualizacja danych - Zestaw 1"
lang: pl
output:
...
Zad.1. Odwzoruj wykres znajdujący się w pliku o nazwie w1.png. Odcienie kolorów mogą się różnić, jednak główne barwy muszą być zachowane.
...
* załaduj dane z pliku nieruchomosci1.csv,
